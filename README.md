...
Este repositorio contiene una colección de los proyectos más significativos que he desarrollado durante mi formación en el grado de Física en la **Universidad de Granada**. En ellos se aplican métodos numéricos avanzados para resolver problemas que abarcan desde la mecánica celeste hasta la física estadística y la mecánica cuántica.

---

## 📂 Contenido del Repositorio

### 1. Estudio de la emergencia de cooperación en redes espaciales 🎮🕸️
...
### 2. Modelo de Hopfield de Red Neuronal 🧠
...
### 3. Ecuación de Schrödinger: Estudio del Coeficiente de Transmisión 🌊
...
### 4. Simulación Dinámica del Sistema Solar (N-Cuerpos) ☀️🪐
...
### 5. Viaje a Marte: Simulación de Órbita de Transferencia de Hohmann 🚀
...
* **Lenguaje:** Python 3.x
* **Librerías:** NumPy, SciPy, Matplotlib (Visualización).
* **Métodos Numéricos:** * Integración de EDOs (Runge-Kutta 4).
  ...
  * Algoritmos de minimización de energía.
