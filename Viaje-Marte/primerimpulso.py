...
plt.show()
"""
impulso = False # Fuera del bucle, antes de empezar
...
for t in range(1, N):
    ...
    if rT > 0.01 and (E_esc>=0) and not impulso:
        ...
        p_phi[t-1] = r_actual * np.sqrt(delta * (2/r_actual - 1/a))
    ...
    distancias = fdistanciam(r[t], phi[t], tiempo2, phi0_M)
