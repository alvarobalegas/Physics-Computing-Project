...
#Condicion de primer patron deformado
...
#Creo la figura de la animación 
fig, ax = plt.subplots()
img = ax.imshow(s.reshape(10, 10)) #Creamos la imagen
...
anim = FuncAnimation(fig, animation, frames=10, interval=300, repeat = False) 
plt.show()
