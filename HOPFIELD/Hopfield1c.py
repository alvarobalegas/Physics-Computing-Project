...
N = 100
s = np.random.choice([0, 1], size = N) #Condicion aleatoria
...
fig, ax = plt.subplots()
img = ax.imshow(s.reshape(10, 10), cmap='Greys') #Creamos la imagen
...
anim = FuncAnimation(fig, animation, frames=10, interval=400, repeat = False) 
plt.show()
